...
RUN cd /xuexi/; wget https://dl.google.com/linux/chrome/deb/pool/main/g/google-chrome-stable/google-chrome-stable_80.0.3987.163-1_amd64.deb; dpkg -i google-chrome-stable_80.0.3987.163-1_amd64.deb; apt-get -fy install; google-chrome --version
